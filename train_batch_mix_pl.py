...
# -*- encoding: utf-8 -*-
"""
@Time    :   2024/01/02 10:32:45
@Author  :   Wang Xu 
@Contact :   wangxu@silexon.tech
@Desc    :   train both peptide-protein and protein-protein
"""
...
class PLPPIHetero(LightningModule):
    ...
    def common_step(self, batch: Batch, stage: str):
        batch_size = batch["pep", "bind", "prot"].edge_label.shape[0]
...
def main(args):
    ...
    mlflow.set_experiment(
        "ppi_graph_dropout_{}_repeat".format(args.split_method)
    )  # set the experiment
