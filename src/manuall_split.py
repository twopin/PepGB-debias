...
class ManualLinkSplit(BaseTransform):
    ...
    def forward(
        ...
        train_data, val_data = copy(data), copy(data)
        ...
        for item in zip(stores, train_stores, val_stores, rev_edge_types):
            store, train_store, val_store, rev_edge_type = item
            ...
            # self._split(
            #     test_store, train_val_edges, is_undirected, rev_edge_type
            # )
            ...
            num_neg = num_neg_train + num_neg_val
